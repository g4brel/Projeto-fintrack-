    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            counter-reset: slide-counter; /* Inicializa o contador de slides */
        }
        ...
        .slide-container {
            ...
            padding: 60px 60px 85px 60px; /* Ajustado padding inferior para o rodapé */
            flex-shrink: 0;
            counter-increment: slide-counter; /* Incrementa o contador a cada slide */
        }
        ...
        .slide-footer .project-name strong {
            color: var(--text-secondary);
        }

        .slide-footer::after {
            content: "Slide " counter(slide-counter); /* Gera o número do slide automaticamente */
        }

        /* Ocultar rodapé em slides de capa/título pretos */
        #slide1 .slide-footer, #slide5 .slide-footer {
            border-top-color: rgba(255, 255, 255, 0.1);
            color: #64748b;
        }
        #slide1 .slide-footer .project-name strong, #slide5 .slide-footer .project-name strong {
            color: #94a3b8;
        }
        ...
        #slide1, #slide5 {
            ...
            justify-content: center;
            text-align: center;
            padding-bottom: 60px; /* Reset do padding para centralizar perfeitamente */
        }
        ...
        .bleed-image-layout .slide-footer {
            left: 60px;
            right: calc(50% + 60px); /* Garante que o rodapé fique apenas do lado do texto */
        }
...
<div class="slide-container" id="slide1">
    ...
    <div class="slide-footer"><span class="project-name"><strong>FinTrack</strong> | Projeto de Interfaces</span></div>
</div>
...
<div class="slide-container bleed-image-layout" id="slide4">
    ...
    <div class="image-container">
        <img class="bleed-image-side" src="https://images.unsplash.com/photo-1531403009284-440f080d1e12?auto=format&fit=crop&w=600&q=80" alt="Design system, color palette and typography">
    </div>
    <div class="slide-footer"><span class="project-name"><strong>FinTrack</strong> | Projeto de Interfaces</span></div>
</div>
    ...
    <div class="content-area">
        <div class="two-column">
            ...
            <div class="image-wrapper">
                <img src="https://images.unsplash.com/photo-1555421689-491a97ff2040?auto=format&fit=crop&w=600&q=80" alt="Clean login screen UI design">
            </div>
        </div>
    </div>
    <div class="slide-footer"><span class="project-name"><strong>FinTrack</strong> | Projeto de Interfaces</span></div>
...
<div class="slide-container" id="slide7">
    ...
    <div class="content-area">
        <div class="two-column">
            ...
            <div class="image-wrapper">
                <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=600&q=80" alt="Personal finance dashboard UI design app">
            </div>
        </div>
    </div>
    <div class="slide-footer"><span class="project-name"><strong>FinTrack</strong> | Projeto de Interfaces</span></div>
...
<div class="slide-container" id="slide8">
    ...
    <div class="content-area">
        <div class="two-column">
            ...
            <div class="image-wrapper">
                <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80" alt="Form input transaction UI design">
            </div>
        </div>
    </div>
    <div class="slide-footer"><span class="project-name"><strong>FinTrack</strong> | Projeto de Interfaces</span></div>
...
<div class="slide-container" id="slide9">
    ...
    <div class="content-area">
        <div class="two-column">
            ...
            <div class="image-wrapper">
                <img src="https://images.unsplash.com/photo-1508385082359-f38ae991e8f2?auto=format&fit=crop&w=600&q=80" alt="Transaction history list UI design">
            </div>
        </div>
    </div>
    <div class="slide-footer"><span class="project-name"><strong>FinTrack</strong> | Projeto de Interfaces</span></div>
    ...
    <div class="content-area">
        <div class="two-column">
            <div class="text-column">
                <div class="bullet-list">
                    <ul>
                        <li><strong>Tela 5 - Configurações:</strong> Agrupamento inteligente de preferências do system e dados do usuário em "switches" táteis.</li>
            ...
            <div class="image-wrapper">
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=600&q=80" alt="User profile settings UI design">
            </div>
        </div>
    </div>
    <div class="slide-footer"><span class="project-name"><strong>FinTrack</strong> | Projeto de Interfaces</span></div>
